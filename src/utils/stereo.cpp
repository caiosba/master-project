// g++ stereo.cpp -lopencv_core -lopencv_video -lopencv_highgui -lopencv_flann -lopencv_objdetect -lopencv_imgproc -lopencv_calib3d -lfreenect -o stereo
// Calibrates two cameras, which must capture the same chessboard
